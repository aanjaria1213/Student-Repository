...
class Repository:
  ...
  __titles__ = ['_path', '_db_path', '_students', '_instructors', '_majors']

  def __init__(self, path: str, db_path: str, ptables: bool = True) -> None:
    """Initializing all fields"""
...
#------------------------------------------------
def main():
  student_repo = Repository("D:\\Documents\\School\\Stevens\\810\\HW11", "D:\\Documents\\School\\Stevens\\810\\HW11\\HW11.db")
